    ...
    this.mesh = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
        ...
        float rect(vec2 position, vec2 size, vec2 center) {
          ...
          float horizontal = step(center.x - halfSize.x, position.x) - step(center.x + halfSize.x, position.x);
          float vertical = step(center.y - halfSize.y, position.y) - step(center.y + halfSize.y, position.y);
        ...
        void main() {
          // draw with position
          float color = rect(uPosition.xy, vec2(1.), vec2(0.));

          // draw with UV coordinates
          // color = rect(vUv, vec2(0.5), vec2(0.));
